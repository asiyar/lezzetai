...
import { LezzetProvider } from "@/lib/lezzet-context";
...
function AppNavigator() {
  const { hydrated, onboardingComplete } = useLezzet();
  if (!hydrated) {
...
export default function RootLayout() {
        ...
        <SafeAreaProvider initialMetrics={providerInitialMetrics}>
          <SafeAreaFrameContext.Provider value={frame}>
            <SafeAreaInsetsContext.Provider value={insets}>
              <LezzetProvider>{content}</LezzetProvider>
  ...
  return (
    <ThemeProvider>
      <SafeAreaProvider initialMetrics={providerInitialMetrics}><LezzetProvider>{content}</LezzetProvider></SafeAreaProvider>
    </ThemeProvider>
  );
}
